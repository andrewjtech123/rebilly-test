...
[![Build Status](https://travis-ci.org/andrewjtech123/rebilly-test.svg?branch=master)](https://travis-ci.org/andrewjtech123/rebilly-test)
...
6. If you did everything correct, https://andrewjtech123.github.io/rebilly-test/ will lead to your new docs
...
- Documentation(ReDoc): https://andrewjtech123.github.io/rebilly-test/
- SwaggerUI: https://andrewjtech123.github.io/rebilly-test/swagger-ui/
- Look full spec:
    + JSON https://andrewjtech123.github.io/rebilly-test/swagger.json
    + YAML https://andrewjtech123.github.io/rebilly-test/swagger.yaml
- Preview spec version for branch `[branch]`: https://andrewjtech123.github.io/rebilly-test/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://andrewjtech123.github.io/rebilly-test/ with url from the message: `Server started <url>`
